        ...
        <section className="relative overflow-hidden border-b border-white/10 px-4 py-16 md:px-8 md:py-24">
          ...
          <div className="relative mx-auto flex max-w-7xl flex-col gap-8">
            <div className="flex max-w-3xl flex-col gap-4">
              <span className="text-[10px] font-black uppercase tracking-[0.5em] text-primary">Catalogo / Palmas TO</span>
              <h1 className="text-6xl font-black uppercase italic leading-[0.85] tracking-tighter md:text-9xl">
                Drops em <span className="text-primary">estoque</span>
              </h1>
              <p className="max-w-xl text-sm font-medium leading-relaxed text-white/45 md:text-base">
                Vitrine completa Baggy Hype com pecas oversized, entrega local e fechamento direto no WhatsApp.
              </p>
            </div>
            <div className="grid grid-cols-1 gap-3 border border-white/10 bg-black/50 p-3 backdrop-blur md:grid-cols-[1fr_220px_180px_auto]">
              <form action="/catalog" className="contents">
                <div className="relative">
                  ...
                  <input name="q" defaultValue={params.q || ""} placeholder="Buscar drop, cor, peca..." className="h-14 w-full bg-white/5 pl-12 pr-4 text-xs font-bold uppercase tracking-widest text-white outline-none placeholder:text-white/25 focus:bg-white/10" />
                </div>
        ...
        <section className="border-y border-white/10 bg-primary px-4 py-10 text-black md:px-8">
          <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-5 text-center md:flex-row md:text-left">
            <div className="flex items-center gap-4">
              <Truck size={28} />
              <h2 className="text-3xl font-black uppercase italic tracking-tighter md:text-5xl">Entrega gratis em Palmas</h2>
            </div>
            <p className="max-w-sm text-[10px] font-black uppercase leading-relaxed tracking-widest">Comprou, chamou no WhatsApp, recebeu no corre local. Simples e direto.</p>
          </div>
        </section>
      </main>
      <Footer />
